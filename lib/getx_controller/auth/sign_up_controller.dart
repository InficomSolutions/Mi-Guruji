...
class SignUpController extends GetxController {
  ...
  Rx<TextEditingController> lastuserName = TextEditingController().obs;
  ...
  Rx<TextEditingController> referal = TextEditingController().obs;
  ...
  togglecPassword() {
    hidecPassword.value = !hidecPassword.value;
  }
